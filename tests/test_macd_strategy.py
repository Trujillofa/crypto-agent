...
class TestMACDHistogramStrategy:
    ...
    async def test_neutral_hold(self, strategy):
        await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": 10.0, "ema_50": 49000.0, "close_price": 50000.0, "atr_pct": 0.01},
        )

        signal = await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": 20.0, "ema_50": 49000.0, "close_price": 50100.0, "atr_pct": 0.01},
        )
    ...
    async def test_bullish_crossover(self, strategy):
        ...
        signal = await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": 10.0, "ema_50": 49000.0, "close_price": 50100.0, "atr_pct": 0.01},
        )
    ...
    async def test_bearish_crossover(self, strategy):
        await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": 10.0, "ema_50": 51000.0, "close_price": 50000.0, "atr_pct": 0.01},
        )

        signal = await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": -10.0, "ema_50": 51000.0, "close_price": 49900.0, "atr_pct": 0.01},
        )
    ...
    async def test_bearish_crossover_fires_above_ema50(self, strategy):
        ...
        await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": 1.44, "ema_50": 67500.0, "close_price": 68189.0, "atr_pct": 0.01},
        )

        signal = await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": -0.93, "ema_50": 67500.0, "close_price": 68189.0, "atr_pct": 0.01},
        )
    ...
    async def test_atr_filter_blocks_signal(self, strategy):
        await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": -10.0, "ema_50": 49000.0, "close_price": 50000.0, "atr_pct": 0.001},
        )

        signal = await strategy.evaluate(
            "BTCUSDT",
            {"macd_hist": 10.0, "ema_50": 49000.0, "close_price": 50100.0, "atr_pct": 0.001},
        )
    ...
    async def test_min_threshold_logic(self):
        strategy = MACDHistogramStrategy({"min_histogram_threshold": 5.0, "use_atr_filter": False})
        ...
        await strategy.evaluate(
            "BTCUSDT", {"macd_hist": -1.0, "ema_50": 49000.0, "close_price": 50000.0}
        )
        signal = await strategy.evaluate(
